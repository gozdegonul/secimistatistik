...
{
    public partial class verisayfa : Form
    {
        public verisayfa()
        {
            InitializeComponent();
        ...
        private void kullanicisayfa_Load(object sender, EventArgs e)
        {
            connect.Open();
            ...
            SqlCommand cmd1 = new SqlCommand("Select İLCEAD from secimtablo", connect);
